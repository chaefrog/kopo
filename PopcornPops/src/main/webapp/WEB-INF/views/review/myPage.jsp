...
<head>
    ...
    <link rel="apple-touch-icon" sizes="57x57" href="/resources/assets/images/apple-touch-icon-iphone.png">
    <link rel="apple-touch-icon" sizes="76x76" href="/resources/assets/images/apple-touch-icon-ipad.png">
    <link rel="apple-touch-icon" sizes="120x120" href="/resources/assets/images/apple-touch-icon-iphone-retina.png">
    <link rel="apple-touch-icon" sizes="152x152" href="/resources/assets/images/apple-touch-icon-ipad-retina.png">
    <link rel="apple-touch-icon" sizes="167x167" href="/resources/assets/images/apple-touch-icon-ipad-pro.png">
    <link rel="apple-touch-icon" sizes="180x180" href="/resources/assets/images/apple-touch-icon-iphone-6-plus.png">
    <link rel="icon" sizes="192x192" href="/resources/assets/images/icon-hd.png">
    <link rel="icon" sizes="128x128" href="/resources/assets/images/icon.png">
    ...
    <link rel="stylesheet" type="text/css" href="/resources/assets/css/jquery.mmenu.css">
...
<body>
    ...
    <div class="wrapper">
            ...
            <div class="container-fluid">
                ...
                <nav class="navbar navbar-expand-lg">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <img src="/resources/assets/images/logo.svg" alt="logo" width="150" class="logo">
                        <!-- INSERT YOUR WHITE LOGO HERE -->
                        <img src="/resources/assets/images/logo-white.svg" alt="white logo" width="150" class="logo-white">
                    </a>
        ...
        <section class="page-header overlay-gradient" style="background: url(/resources/assets/images/posters/movie-collection.jpg);">
            <div class="container">
                <div class="inner">
                        ...
                        <div class="owl-carousel testimonial-slider">
                            ...
                            <div class="item">
                                <div class="testimonial-content">
                                    <img src="/resources/assets/images/celebrities/celebrity1.jpg" alt="PIC 유저프로필 사진">
                                    <div class="testimonial-comment">
                                        <h4>ID 님 | NICK 닉네임</h4>
                                        <span class="testimonial-info">리뷰어 랭킹</span>
                                        <p>EMAIL 이메일</p>
                                        <p>INTRO "소개글"</p>
                                        <br>
                                        <div id="how-many-popcorn">
                                            <p>지금까지 내가 받은 팝콘 수는!</p>
                                            <div>PID 팝콘 수</div>
                                        </div>
                                        <br>
                                        <a href="#" class="btn btn-main btn-effect">로그아웃</a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="widget widget-about">
                                ...
                                <!-- INSERT YOUR WHITE LOGO HERE -->
                                <img src="/resources/assets/images/logo-white.svg" alt="white logo" class="logo-white">
